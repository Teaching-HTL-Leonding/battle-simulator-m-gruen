...
double damagemultiplayerPlayer1 = Random.Shared.Next(85, 126) / 100d;
double damagemultiplayerPlayer2 = Random.Shared.Next(85, 125) / 100d;
...
{
    healthPlayer1 -= damagePlayer2*speedPlayer2 * damagemultiplayerPlayer2;
    healthPlayer2 -= damagePlayer1*speedPlayer1 * damagemultiplayerPlayer1;
    //Console.WriteLine(damagePlayer1*speedPlayer1 * damagemultiplayerPlayer1);
    //Console.WriteLine(damagePlayer2*speedPlayer2 * damagemultiplayerPlayer2);
    damagemultiplayerPlayer1 = Random.Shared.Next(85, 126) / 100d;
    damagemultiplayerPlayer2 = Random.Shared.Next(85, 125) / 100d;
}
